    ...
    return (
        <div className="flex flex-col justify-center min-h-screen p-8 bg-gradient-to-r from-[#12122b] to-[#0e0e1d]">
            ...
            <section className="max-w-4xl mx-auto bg-gray-200 p-8 rounded-lg shadow-md">
                <div className="mb-8">
                    <h2 className="text-2xl font-bold te flex justify-center items-center mb-4">Overview</h2>
                ...
                <div className="mb-8">
                    ...
                    <div className="mb-6">
                        <h3 className="text-xl font-semibold mb-2">2. Prescription 📝</h3>
                        <ul className="list-disc pl-6 text-gray-700">
                    ...
                    <div className="mb-6">
                        <h3 className="text-xl font-semibold mb-2">3. Navigation🏥</h3>
                        <ul className="list-disc pl-6 text-gray-700">
                    ...
                    <div className="mb-6">
                        <h3 className="text-xl font-semibold mb-2">4. Consultation📞</h3>
                        <ul className="list-disc pl-6 text-gray-700">
                    ...
                    <div className="mb-6">
                        <h3 className="text-xl font-semibold mb-2">5. Recovery📊</h3>
                        <ul className="list-disc pl-6 text-gray-700">
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-4">Why Choose MedicalRx?</h2>
